package com.example.customcalender_test.uihelpers;
...
import com.example.customcalender_test.R;
...
public class CalendarDialog {
    ...
    private class ViewPagerAdapter extends PagerAdapter {
        ...
        private List<Event> getCalendarEventsOfDay(Calendar day) {
           ...
           Log.d("calDialog", String.valueOf(day));

            for (Event e : mEventList) {
                Calendar eventDay = e.getDate();
                if (diffYMD(e.getDate(), day) == 0) {
                    eventList.add(e);
                    Log.d("calDialog same", String.valueOf(e.getDate()));
                    Log.d("calDialog title", String.valueOf(e.getTitle()));
                }
            }
            return eventList;
        }
    ...
    private class CalendarEventAdapter extends RecyclerView.Adapter<CalendarEventAdapter.ViewHolder>{
        ...
        CalendarEventAdapter(List<Event> events) { mCalendarEvents = events; }
